...
public class EntradaStock {
    ...
    public EntradaStock(Long id, String numero, Date fecha, int facturado, int actualizado, Long user_id, Long empresa_id, int activo, int borrado, Date created_at, Date updated_at, Long proveedor_id, Long almacen_id, Empresa empresa, User user) {
        this.id = id;
        this.numero = numero;
        this.fecha = fecha;
